...
Java_com_mentra_examples_androidwebrtcreceiver_GStreamerWhipReceiver_nativeInit(JNIEnv *env, jobject thiz) {
...
JNIEXPORT void JNICALL
Java_com_mentra_examples_androidwebrtcreceiver_GStreamerWhipReceiver_nativeFinalize(JNIEnv *env, jobject thiz) {
...
JNIEXPORT void JNICALL
Java_com_mentra_examples_androidwebrtcreceiver_GStreamerWhipReceiver_nativeStart(JNIEnv *env,
                                                                                 jobject thiz,
                                                                                 jstring bind_uri) {
    ReceiverData *data = get_receiver_data(env, thiz);
    if (!data) {
...
JNIEXPORT void JNICALL
Java_com_mentra_examples_androidwebrtcreceiver_GStreamerWhipReceiver_nativeStop(JNIEnv *env, jobject thiz) {
    ReceiverData *data = get_receiver_data(env, thiz);
    if (!data) {
        return;
    }
...
JNIEXPORT void JNICALL
Java_com_mentra_examples_androidwebrtcreceiver_GStreamerWhipReceiver_nativeSurfaceInit(JNIEnv *env,
                                                                                       jobject thiz,
                                                                                       jobject surface) {
    (void)env;
    (void)thiz;
...
JNIEXPORT void JNICALL
Java_com_mentra_examples_androidwebrtcreceiver_GStreamerWhipReceiver_nativeSurfaceFinalize(JNIEnv *env,
                                                                                           jobject thiz) {
    (void)env;
    (void)thiz;
}
